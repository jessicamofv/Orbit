<%-- 
    Document   : customerReservations
    Created on : Apr 22, 2015, 9:49:15 PM
    Author     : Jessica
--%>
                    ...
                    <fieldset>
                        ...
                        <div class="pure-g-r">
                            ...
                            <div class="pure-u-1-3">
                                <label for="cancel-reservation-option" class="pure-radio">
                                    <input id="cancel-reservation-option" type="radio" name="resrActions" value="cancel">
                                    Cancel Reservation
                                </label>
                            </div>

                            <div class="pure-u-1-3">
                                <label for="current-reservations-option" class="pure-radio">
                                    <input id="current-reservations-option" type="radio" name="resrActions" value="current">
                                    Current Reservations
                                </label>
                            </div>

                            <div class="pure-u-1-3">
                                <label for="reservation-history-option" class="pure-radio">
                                    <input id="reservation-history-option" type="radio" name="resrActions" value="history">
                                    Reservation History
                                </label>
                            </div>
                        ...
                        <script>
                            ...
                            $('#cancel-reservation-option').click(function() {
                                 if ($('#cancel-reservation-option').is(':checked')) {
                                    $('#cancel-reservation').load('loadCancelReservation.html');
                                }
                            });

                            $('#current-reservations-option').click(function() {
                                 if ($('#current-reservations-option').is(':checked')) {
                                    $('#cancel-reservation').load('loadCurrentReservations.html');
                                }
                            });

                            $('#reservation-history-option').click(function() {
                                 if ($('#reservation-history-option').is(':checked')) {
                                    $('#cancel-reservation').load('loadReservationHistory.html');
                                }
                            });
