<%-- 
    Document   : managerCustomers
    Created on : Apr 23, 2015, 1:01:02 AM
    Author     : Jessica
--%>
        ...
        <div id="layout">
            ...
            <div id="main">
                ...
                <div class="content">
                    ...
                    <h2 class="content-subhead">Find Customer Seat Numbers</h2>

                    <fieldset class="pure-group">

                        <form id='findByAirline' method="post" action="customerSeatList">
                            
                            <label for="resAirlineID">                        
                                Flight ID:   <input type="text" id="resAirlineID" name="resAirlineID" class="" placeholder="AA">                        
                            </label>
                            
                            <label for="resAirlineID">                        
                                Flight Number: <input type="text" id="resFlightNo" name="resFlightNo" class="" placeholder="111">
                            </label>
                            
                            <div>&nbsp;</div>
                            
                        <button type='submit' class='pure-button'>Find Seat Numbers!</button>                            
