<%-- 
    Document   : customerRepBids
    Created on : Apr 23, 2015, 12:19:50 AM
    Author     : Jessica
--%>
        ...
        <div id="layout">
            ...
            <div id="main">
                ...
                <div class="content">
                    ...
                    <fieldset>
                        <form id='pending-bids-form' method="POST" action='viewPendingBids'>
                            <button type="submit" class="pure-button pure-button-primary">View Pending Bids!</button>
                        </form>
                    </fieldset>
