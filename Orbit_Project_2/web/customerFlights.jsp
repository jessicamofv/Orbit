<%-- 
    Document   : customerFlights
    Created on : Apr 22, 2015, 11:49:01 PM
    Author     : Jessica
--%>
        ...
        <div id="layout">
            ...
            <div id="main">
                ...
                <div class="content">
                    ...
                    <fieldset>
                        <div id="flightsRadioList">

                            <div class="pure-g-r">

                                <div class="pure-u-1-3">
                                    <label for="bestSeller" class="pure-radio">
                                        <input id="bestSeller" type="radio" name="flightActions" value="bestSeller">
                                         Best-Seller List of Flights
                                    </label>
                                </div>

                                <div class="pure-u-1-3">
                                    <label for="flightSuggestions" class="pure-radio">
                                        <input id="flightSuggestions" type="radio" name="flightActions" value="flightSuggestions">
                                         Flight Suggestions
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="pure-g-r">
                            ...
                            <div class="pure-u-1-3" id="flights-div0">

                                <div>&nbsp;</div>

                                <fieldset class="pure-group">

                                    <legend><strong>Best-Seller List of Flights</strong></legend>

                                    <form id='best-seller-form' method="post" action="bestSellerFlightList">

                                        <button type='submit' class='pure-button'>Generate!</button>                            
                            ...
                            <div class="pure-u-1-3" id="flights-div1">

                                <div>&nbsp;</div>

                                <fieldset class="pure-group">

                                    <legend><strong>Flight Suggestions</strong></legend>

                                    <form id='flight-suggestions-form' method="post" action="flightSuggestions">

                                        <input id="accountNo" name="accountNo" type="hidden" />

                                        <button type='submit' class='pure-button'>Generate Flight Suggestions!</button>                            
