<%-- 
    Document   : customerRepCustomerMailingLists
    Created on : Apr 23, 2015, 12:13:29 AM
    Author     : Jessica
--%>
        ...
        <div id="layout">
            ...
            <div id="main">
                ...
                <div class="content">
                    ...
                    <fieldset>
                        <form id='mailing-lists-form' method="POST" action='customerMailingLists'>
                           <button type="submit" class="pure-button pure-button-primary">Generate Customer Mailing Lists!</button>
                        </form>
                    </fieldset>
