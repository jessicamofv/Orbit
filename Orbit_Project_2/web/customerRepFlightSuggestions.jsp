<%-- 
    Document   : customerRepFlightSuggestions
    Created on : Apr 23, 2015, 12:15:59 AM
    Author     : Jessica
--%>
        ...
        <div id="layout">
            ...
            <div id="main">
                ...
                <div class="content">
                    ...
                    <h2 class="content-subhead">Flight Suggestions</h2>
                    ...
                    <fieldset>
                        <form id='flight-suggestions-form' method="POST" action='flightSuggestions'>
                            ...
                            <button type="submit" class="pure-button pure-button-primary">Generate Flight Suggestions!</button>
