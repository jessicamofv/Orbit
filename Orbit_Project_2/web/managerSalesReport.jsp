<%-- 
    Document   : managerSalesReport
    Created on : Apr 23, 2015, 12:30:21 AM
    Author     : Jessica
--%>
        ...
        <div id="layout">
            ...
            <div id="main">
                ...
                <div class="content">
                    ...
                    <h2 class="content-subhead">Sales Report</h2>

                    <fieldset>
                        <form id='sales-report-form' method="POST" action='salesReport'>
                            <div class="pure-g-r">
                    ...
                    <!--            <div class="pure-u-1-3">
                            ...
                            <button type="submit" class="pure-button pure-button-primary">Generate Sales Report!</button>
